            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="col-12" id="banner" style="background-image:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 5)), url('../assets/img/logo1.jpg');">
                            <div class="row">
                                 <div class="col-8" style = "margin-top: 5px;">
                                     <div id="banner_left" class = "section"> 
                         <p style="color:yellow;"> <b>WELCOME TO OZARAMBA FOUNDATION</b> </p>
                            <h1 class = "banner_write" style="color:white; font-family: sans-seriff;  font-style:opaque; font-weight:Bold;">
                            WHERE WE PUT COMPASSION INTO ACTION </h1>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\ozaramba\resources\views/home.blade.php ENDPATH**/ ?>